...
INSERT INTO courses (id, subject_id, code, title, term) VALUES
  ...
  ('b1000000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000003', 'PHYS 210', 'Introduction to Relativity and Quantum Physics', '2026W1'),
...
INSERT INTO courses (id, subject_id, code, title, term) VALUES
  ...
  ('b1000000-0000-0000-0000-000000000015', 'a1000000-0000-0000-0000-000000000005', 'BIOL 300', 'Molecular Biology', '2026W1')
ON CONFLICT (subject_id, code, term) DO NOTHING;

-- STAT courses
INSERT INTO courses (id, subject_id, code, title, term) VALUES
  ('b1000000-0000-0000-0000-000000000016', 'a1000000-0000-0000-0000-000000000006', 'STAT 200', 'Elementary Statistics', '2026W1'),
...
INSERT INTO courses (id, subject_id, code, title, term) VALUES
  ...
  ('b1000000-0000-0000-0000-000000000021', 'a1000000-0000-0000-0000-000000000007', 'ECON 325', 'Industrial Organization', '2026W1')
ON CONFLICT (subject_id, code, term) DO NOTHING;
...
INSERT INTO rooms (id, name, building, floor, capacity, map_url) VALUES
  ('c1000000-0000-0000-0000-000000000001', 'IKBLC 182', 'Irving K. Barber Learning Centre', '1', 20, 'https://maps.ubc.ca/?code=IKBLC'),
  ('c1000000-0000-0000-0000-000000000002', 'IKBLC 261', 'Irving K. Barber Learning Centre', '2', 16, 'https://maps.ubc.ca/?code=IKBLC'),
  ('c1000000-0000-0000-0000-000000000003', 'Koerner 216', 'Koerner Library', '2', 12, 'https://maps.ubc.ca/?code=KOEL'),
  ('c1000000-0000-0000-0000-000000000004', 'Koerner 302', 'Koerner Library', '3', 8, 'https://maps.ubc.ca/?code=KOEL'),
  ('c1000000-0000-0000-0000-000000000005', 'Woodward 4', 'Woodward Library', 'B', 24, 'https://maps.ubc.ca/?code=WOOD'),
  ('c1000000-0000-0000-0000-000000000006', 'Woodward 8', 'Woodward Library', 'B', 12, 'https://maps.ubc.ca/?code=WOOD'),
  ('c1000000-0000-0000-0000-000000000007', 'ICICS 246', 'ICICS', '2', 30, 'https://maps.ubc.ca/?code=ICCS'),
  ('c1000000-0000-0000-0000-000000000008', 'ICICS X150', 'ICICS', '1', 20, 'https://maps.ubc.ca/?code=ICCS'),
  ('c1000000-0000-0000-0000-000000000009', 'Nest 2306', 'The Nest (AMS Student Union Building)', '2', 16, 'https://maps.ubc.ca/?code=NEST'),
  ('c1000000-0000-0000-0000-000000000010', 'Nest 3301', 'The Nest (AMS Student Union Building)', '3', 10, 'https://maps.ubc.ca/?code=NEST')
ON CONFLICT (id) DO NOTHING;
